...
//
//     final smartModel = smartModelFromJson(jsonString);

import 'dart:convert';

SmartModel smartModelFromJson(String str) => SmartModel.fromJson(json.decode(str));

String smartModelToJson(SmartModel data) => json.encode(data.toJson());
...
class SmartModel {
  ...
  factory SmartModel.fromJson(Map<String, dynamic> json) => SmartModel(
